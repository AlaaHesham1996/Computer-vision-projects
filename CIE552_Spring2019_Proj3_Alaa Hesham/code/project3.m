...
% [k, train_image_paths, test_image_paths, train_labels, test_labels] = ...
...
h = get(0,'children');
for i=1:length(h)
%   saveas(h(i), ['vSize' num2str(vSize) 'figure' num2str(i)], 'jpg');
  saveas(h(i), ['vSize' num2str(vSize) 'figure' num2str(i)], 'jpg');
end

timeTaken(runInd) = endTime-startTime;
vSizeMat(runInd) = vSize;
runInd = runInd +1;
